...
//    public class CategoriesController : ControllerBase<Category, CategoryModel, Guid>
//    {
...
//        public override async Task<IActionResult> List(ODataQueryOptions<CategoryModel> options)
//        {
//            return await List(
//                request: new CategoryListRequest(options),
