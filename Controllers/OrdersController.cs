...
//    public class OrdersController : ControllerBase<Order, OrderModel, Guid>
//    {
...
//        public override async Task<IActionResult> List(ODataQueryOptions<OrderModel> options)
//        {
//            return await List(
//                request: new OrderListRequest(options)
//                {
