...
//    public class PaymentsController : ControllerBase<Payment, PaymentModel, Guid>
//    {
...
//        public override async Task<IActionResult> List(ODataQueryOptions<PaymentModel> options)
//        {
//            return await List(
//                request: User.IsInRole("Admin")
//                    ? new PaymentListRequest(options)
//                    : new PaymentListRequest(options, Guid.Parse(User.FindFirst("sub").Value)),
